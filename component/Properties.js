      ...
      <View
        ...
        <View style={{width: 110, height: 120, overflow: 'hidden'}}>
          <Image
            ...
            style={{width: 130, height: 120, borderRadius: 20, marginRight: 10}}
          />
        </View>
        <View style={{marginLeft: 10, gap: 10, justifyContent: 'space-evenly'}}>
          ...
          <Text style={{fontSize: 12, color: '#5552E9', marginBottom: 10}}>
            {property.area}
          </Text>
          <Text style={{fontSize: 15, color: '#5552E9', marginBottom: 20}}>
            ${property.price}
          </Text>
        </View>
      </View>
